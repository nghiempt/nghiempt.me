...
import { IconApartment, IconBriefcase, IconBytedanceLogo, IconFeishuLogo, IconHelpCircle, IconTwitter, IconSearch, IconUploadError } from '@douyinfe/semi-icons';
      ...
      <div className="flex justify-start items-center border-b border-gray-100">
        <div className="flex flex-row gap-3 justify-center items-center pb-[5px]">
          <Image
            ...
            height={20}
            alt="loading"
            className={'!bg-[#00000000] flex items-center justify-center hover:pointer'}
          />
  ...
  return (
    ...
    >
      <div className="self-stretch shrink-0 flex flex-col items-center gap-y-[16px]">
        ...
        {
          fake_categories?.map((category: any, index: any) => <div key={index} className='w-full'> <div className="self-stretch shrink-0 flex items-center">
                ...
                >
                  <div className='!bg-white border border-gray-100 p-4 rounded-xl flex items-center justify-center' >
                    <Image
                      ...
                      className={'!bg-[#00000000] flex items-center justify-center'}
                    />
                  </div>
